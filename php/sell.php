...
$mysql_qry = "select * from PlayerHistory where CompanyID = $companyID and BuySell = 1;";
$result = mysqli_query($conn, $mysql_qry);
...
$mysql_qry = "select * from PlayerHistory where CompanyID = $companyID and BuySell = 0;";
$result = mysqli_query($conn, $mysql_qry);
